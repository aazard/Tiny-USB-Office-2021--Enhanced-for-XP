...
2002-2013 Windows port by Donnie Russell
Based on PC Rogue 1.48

Tiles by Oryx (http://oryxdesignlab.com/)

Mersenne Twist pseudorandom number generator implementation version 0.7 by
Geoff Kuenning (http://www.cs.hmc.edu/~geoff/mtwist.html).

ClassicRogue is freeware. It is provided in the hope that it will be
entertaining and/or useful. It comes with absolutely no warranty. Use it at
your own risk.
