...
#
## Ex.33
# save the file to the existing folder only. Quiet mode should be ON.
# On target drive file must be copied to existing folder(s) A, B or C
# D:\Doc\01.txt  >  E:\File\A  /up
# D:\Doc\01.txt  >  E:\File\B  /up
# D:\Doc\01.txt  >  E:\File\C  /up
#
#
#
#
