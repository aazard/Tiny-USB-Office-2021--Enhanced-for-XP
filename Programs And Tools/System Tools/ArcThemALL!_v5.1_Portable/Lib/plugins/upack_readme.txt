 ...
 \\ \_    /   //   /   //   /   //   /   //   /   ___// //
     ...
     ====< Files >====================================================
      ...
      WinUpackE.exe  --- GUI version of Upack (English)
      WinUpackSC.exe --- GUI version of Upack (Simplified Chinese)
      WinUpackR.exe  --- GUI version of Upack (Russian)
      WinUpackTC.exe --- GUI version of Upack (Traditional Chinese)
      WinUpackRY.exe --- English GUI version (modified by Luis R0y0)
      WinUpackJ.exe  --- GUI version of Upack (Japanese)
     ...
     * IMOK's               Traditional Chinese support
     * Northfox's           MEW
     * ryg's                kkrunchy
     * URSoftware's         W32Dasm
     * rambo/the_loop's     logo
     * Raiko's              icon
     * Wanchun.D            Japanese version
